package com.jiumai.base.common.core.manager;
...
public class AsyncFactory {
     ...
     * @return 任务task
     */
    public static TimerTask recordOper(final SmOpLog operLog) {
        return new TimerTask() {
            @Override
            public void run() {
                // 远程查询操作地点
                SpringUtils.getBean(OpLogMapper.class).insert(operLog);
            }
        };
    }
